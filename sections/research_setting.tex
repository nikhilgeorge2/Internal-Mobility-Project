...
\begin{table}[t]
    ...
    \bottomrule
    \multicolumn{4}{l}{\footnotesize \textit{Notes:} Data from HRIS covering 2018-2021, supplemented by 1,638 pre-2018 position postings.} \
    \multicolumn{4}{l}{\footnotesize Internal Applications (%) represents positions receiving at least one internal application.} \
    \multicolumn{4}{l}{\footnotesize Internal Fills (%) represents positions filled by internal candidates.} \
    \label{tab:summary}
    \end{tabular*}
\end{table}
...
of positions receiving internal applications rising from 40.3% in 2018 to 62.5% in 2021.
...
\begin{table}[t]
    ...
    \bottomrule
    \multicolumn{7}{l}{\footnotesize \textit{Notes:} Sample entries from HRIS. Employee ID is populated for internal applicants or when external} \
    \multicolumn{7}{l}{\footnotesize candidates are selected. Job Description field contains complete posting content (see Box \ref{box:vacancy_posting})} \
    \multicolumn{7}{l}{\footnotesize for representative example of full posting content. Internal flag indicates current employee status.} \
...
\begin{table}[t]
    ...
    \vdots & \vdots & \vdots & \vdots & \vdots \
    \bottomrule
    \multicolumn{5}{l}{\footnotesize \textit{Notes:} Derived from HRIS data by linking internal applicants' Employee IDs to their current} \
    \multicolumn{5}{l}{\footnotesize positions. Both current and applied-to positions contain detailed requirements as shown in Box \ref{box:vacancy_posting}.} \
