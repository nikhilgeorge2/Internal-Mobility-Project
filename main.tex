...
% Page Layout and Customizations
\usepackage{geometry}
\geometry{margin=1in} % Adjust margins as needed
\usepackage{setspace}
\onehalfspacing % Set line spacing to 1.5
\usepackage{parskip}  % For adjusting paragraph spacing

% Fonts and Section Title Customizations
...
\usepackage{graphicx, placeins} % Required for inserting images
\usepackage{svg}
...
% Link and Color Settings
\usepackage{hyperref}  % For clickable links, if needed
\usepackage{xcolor}
\usepackage{caption}
\usepackage{tikz}
\usepackage{enumitem}
\definecolor{boxbackground}{HTML}{F0F0F0}  % light grey background
\definecolor{boxframe}{HTML}{000000}       % black frame

\usetikzlibrary{positioning} 
\usepackage{booktabs, array, colortbl, tcolorbox} 
...
\titlespacing*{\paragraph}{0pt}{1.5ex plus 0.5ex minus 0.2ex}{1em} % Adjust paragraph spacing

\title{How Informative are Job Posting Skill Measures? Evidence from Selection Decisions}

\author{} % Author names and affiliations removed

\date{November, 2024} % Customize date as needed
...
{% Start of the local line spacing change
...
\end{abstract}
} % End of the local line spacing change
